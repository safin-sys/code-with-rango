            ...
            <NextLink href={`/post/${slug}`}>
                <a>
                    <Box mt="1.25rem">
                        ...
                        <Text style={textStyle}>We've crammed the most important information to help you get started with Ghost into this one post. It's your cheat-sheet to get started, and your shortcut to advanced features.</Text>
                    </Box>
                </a>
            </NextLink>
        </Flex>
